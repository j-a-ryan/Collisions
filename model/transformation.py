...
def set_up_config_data(vector_V, vector_Y_for_calculated_V, vector_Y, argument_type, third_vector=None, return_vector_in_minkowski_form=True, convert_incoming_vector_to_lcc=True):
        matrix_configuration_data = LightConeRapidityMatrixConfigurationData()
        matrix_configuration_data.exp_2yT = config.exp_2yT # for V and V_PLUS_Y
        match argument_type:
            case util.V:
            ...
            case util.V_MINUS_Y:
                ...
                matrix_configuration_data.exp_2yT = solve_for_second_step_transformation_exp_2yT(matrix_configuration_data.rest_frame_vector, vector_Y, third_vector)
...
def handle_transformation(vector_V, vector_Y, V_particle_name, Y_particle_name, particle_names, experiment, argument_type, third_vector=None):
    ...
    match argument_type:
        ...
        case util.V_MINUS_Y:
            ...
            transformed_vectors = transform(vector_V_prime, vector_Y_prime, vector_Y, initial_transformed_vectors, argument_type, third_vector=third_vector)
        case util.V_PLUS_Y:
            transformed_vectors = transform(vector_V, vector_Y, vector_Y, original_vectors, argument_type)
