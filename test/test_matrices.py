...
class TestLightConeRapidityMatrix(unittest.TestCase):
    ...
    def test_basic_case_minkowski_Y_vec_lcc_out(self):
        ...
        correctly_transformed_vector_Y_lcc = [
            math.sqrt((2169 - 704 * config.sqrt2) / 41),
            math.sqrt(2169 / 164 + 176 * config.sqrt2 / 41),
            -2 * math.sqrt(6),
            0,
        ]
        ...
        correctly_transformed_vector_Y_mink = [
            (2 * math.sqrt(2169 - 704 * config.sqrt2) + math.sqrt(2169 + 704 * config.sqrt2)) / (2 * config.sqrt2),
            -2 * math.sqrt(6),
            0,
            math.sqrt((2169 - 704 * config.sqrt2) / 82) - 0.5 * math.sqrt((2169 + 704 * config.sqrt2) / 82),
        ]
